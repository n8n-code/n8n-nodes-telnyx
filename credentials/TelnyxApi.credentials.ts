...
export class TelnyxApi implements ICredentialType {
	...
	icon: Icon = { light: 'file:../nodes/Telnyx/telnyx.svg', dark: 'file:../nodes/Telnyx/telnyx.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			required: true,
			placeholder: 'https://api.telnyx.com/v2',
			description: 'The base URL of your telnyx API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
