...
export const credentialConnectionsDescription: INodeProperties[] = [
		{
			...
			"options": [
				{
					...
					"value": "List Credential Connections",
				...
				},
				{
					...
					"value": "Create Credential Connection",
					"action": "Create a credential connection",
				...
				},
				{
					...
					"value": "Delete Credential Connection",
					"action": "Delete a credential connection",
					"description": "Deletes an existing credential connection.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/credential_connections/{{$parameter[\"id\"]}}"
						}
					}
				},
				{
					"name": "Retrieve Credential Connection",
					"value": "Retrieve Credential Connection",
					"action": "Retrieve a credential connection",
				...
				},
				{
					...
					"value": "Update Credential Connection",
					"action": "Update a credential connection",
		...
		{
			"displayName": "GET /credential_connections",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /credential_connections",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		},
		{
			...
			"name": "password",
			"type": "string",
			"default": "my123secure456password789",
		...
		{
			"displayName": "Sip Uri Calling Preference",
			...
			"routing": {
				"send": {
					"property": "sip_uri_calling_preference",
					"propertyInDotNotation": false,
					"type": "body",
					"value": "={{ $value }}"
				}
		...
		{
			"displayName": "DELETE /credential_connections/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /credential_connections/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PATCH /credential_connections/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
